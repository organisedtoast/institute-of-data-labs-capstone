// This harness talks to the real Express app, real local MongoDB, and real
// ROIC API. It avoids brittle exact-value checks and instead proves that the
// expanded grouped schema and override flows survive a live import.
