...
const DISPLAY_FIELD_DEFINITIONS = [
  ...
  displayField("annualData[].forecastData.fy1.enterpriseValue", "Enterprise value FY+1", "Balance Sheet", "detail", CATEGORY_SET.allButLenders, 220),
  displayField("annualData[].forecastData.fy2.enterpriseValue", "Enterprise value FY+2", "Balance Sheet", "detail", CATEGORY_SET.allButLenders, 230),
  displayField("annualData[].forecastData.fy3.enterpriseValue", "Enterprise value FY+3", "Balance Sheet", "detail", CATEGORY_SET.allButLenders, 240),
  ...
  displayField("annualData[].forecastData.fy1.sharesOnIssue", "Shares on issue forecast FY+1", "Shares & Market Cap", "detail", CATEGORY_SET.all, 630),
  displayField("annualData[].forecastData.fy2.sharesOnIssue", "Shares on issue forecast FY+2", "Shares & Market Cap", "detail", CATEGORY_SET.all, 640),
  displayField("annualData[].forecastData.fy3.sharesOnIssue", "Shares on issue forecast FY+3", "Shares & Market Cap", "detail", CATEGORY_SET.all, 650),
  displayField("annualData[].forecastData.fy1.marketCap", "Market cap FY+1", "Shares & Market Cap", "detail", CATEGORY_SET.all, 670),
  displayField("annualData[].forecastData.fy2.marketCap", "Market cap FY+2", "Shares & Market Cap", "detail", CATEGORY_SET.all, 680),
  displayField("annualData[].forecastData.fy3.marketCap", "Market cap FY+3", "Shares & Market Cap", "detail", CATEGORY_SET.all, 690),

  displayField("annualData[].forecastData.fy1.ebit", "EBIT FY+1", "EBIT Forecast", "detail", CATEGORY_SET.allButUnprofitableAndLenders, 710),
  displayField("annualData[].forecastData.fy2.ebit", "EBIT FY+2", "EBIT Forecast", "detail", CATEGORY_SET.allButUnprofitableAndLenders, 720),
  displayField("annualData[].forecastData.fy3.ebit", "EBIT FY+3", "EBIT Forecast", "detail", CATEGORY_SET.allButUnprofitableAndLenders, 730),
  ...
  displayField("annualData[].forecastData.fy1.evSales", "EV/Sales FY+1", "Valuation Multiples", "detail", CATEGORY_SET.unprofitableOnly, 820),
  displayField("annualData[].forecastData.fy2.evSales", "EV/Sales FY+2", "Valuation Multiples", "detail", CATEGORY_SET.unprofitableOnly, 830),
  ...
  displayField("annualData[].forecastData.fy1.ebitdaMargin", "EBITDA margin FY+1", "Valuation Multiples", "detail", CATEGORY_SET.unprofitableOnly, 850),
  displayField("annualData[].forecastData.fy2.ebitdaMargin", "EBITDA margin FY+2", "Valuation Multiples", "detail", CATEGORY_SET.unprofitableOnly, 860),
  ...
  displayField("annualData[].forecastData.fy1.ebitMargin", "EBIT margin FY+1", "Valuation Multiples", "detail", CATEGORY_SET.allButLenders.filter((name) => name !== "Defensive Yield"), 880),
  displayField("annualData[].forecastData.fy2.ebitMargin", "EBIT margin FY+2", "Valuation Multiples", "detail", CATEGORY_SET.allButLenders.filter((name) => name !== "Defensive Yield"), 890),
  ...
  displayField("annualData[].forecastData.fy1.npatMargin", "NPAT margin FY+1", "Valuation Multiples", "detail", CATEGORY_SET.allButUnprofitableAndLenders, 910),
  displayField("annualData[].forecastData.fy2.npatMargin", "NPAT margin FY+2", "Valuation Multiples", "detail", CATEGORY_SET.allButUnprofitableAndLenders, 920),
  displayField("annualData[].forecastData.fy3.npatMargin", "NPAT margin FY+3", "Valuation Multiples", "detail", CATEGORY_SET.allButUnprofitableAndLenders, 930),
  ...
  displayField("annualData[].forecastData.fy1.evEbit", "EV/EBIT FY+1", "Valuation Multiples", "detail", CATEGORY_SET.allButUnprofitableAndLenders, 950),
  displayField("annualData[].forecastData.fy2.evEbit", "EV/EBIT FY+2", "Valuation Multiples", "detail", CATEGORY_SET.allButUnprofitableAndLenders, 960),
  displayField("annualData[].forecastData.fy3.evEbit", "EV/EBIT FY+3", "Valuation Multiples", "detail", CATEGORY_SET.allButUnprofitableAndLenders, 970),
  ...
  displayField("annualData[].forecastData.fy1.pe", "PE FY+1", "Valuation Multiples", "detail", CATEGORY_SET.allButUnprofitable, 990),
  displayField("annualData[].forecastData.fy2.pe", "PE FY+2", "Valuation Multiples", "detail", CATEGORY_SET.allButUnprofitable, 1000),
  displayField("annualData[].forecastData.fy3.pe", "PE FY+3", "Valuation Multiples", "detail", CATEGORY_SET.allButUnprofitable, 1010),
  ...
  displayField("annualData[].growthForecasts.revenueCagr3y", "Revenue forecast CAGR 3Y", "Growth & Forecasts", "detail", CATEGORY_SET.all, 1110),
  displayField("annualData[].growthForecasts.revenueCagr5y", "Revenue forecast CAGR 5Y", "Growth & Forecasts", "detail", CATEGORY_SET.all, 1120),
  displayField("annualData[].growthForecasts.epsCagr3y", "EPS forecast CAGR 3Y", "Growth & Forecasts", "detail", CATEGORY_SET.allButUnprofitable, 1130),
  displayField("annualData[].growthForecasts.epsCagr5y", "EPS forecast CAGR 5Y", "Growth & Forecasts", "detail", CATEGORY_SET.allButUnprofitable, 1140),

  displayField("annualData[].analystRevisions.revenueFy1Last1m", "Revenue FY+1 revisions last 1M", "Analyst Revisions", "detail", CATEGORY_SET.all, 1210),
  displayField("annualData[].analystRevisions.revenueFy1Last3m", "Revenue FY+1 revisions last 3M", "Analyst Revisions", "detail", CATEGORY_SET.all, 1220),
  displayField("annualData[].analystRevisions.revenueFy2Last1m", "Revenue FY+2 revisions last 1M", "Analyst Revisions", "detail", CATEGORY_SET.all, 1230),
  displayField("annualData[].analystRevisions.revenueFy2Last3m", "Revenue FY+2 revisions last 3M", "Analyst Revisions", "detail", CATEGORY_SET.all, 1240),
  displayField("annualData[].analystRevisions.ebitFy1Last1m", "EBIT FY+1 revisions last 1M", "Analyst Revisions", "detail", CATEGORY_SET.all, 1250),
  displayField("annualData[].analystRevisions.ebitFy1Last3m", "EBIT FY+1 revisions last 3M", "Analyst Revisions", "detail", CATEGORY_SET.all, 1260),
  displayField("annualData[].analystRevisions.ebitFy2Last1m", "EBIT FY+2 revisions last 1M", "Analyst Revisions", "detail", CATEGORY_SET.all, 1270),
  displayField("annualData[].analystRevisions.ebitFy2Last3m", "EBIT FY+2 revisions last 3M", "Analyst Revisions", "detail", CATEGORY_SET.all, 1280),
  displayField("annualData[].analystRevisions.ebitFy3Last1m", "EBIT FY+3 revisions last 1M", "Analyst Revisions", "detail", CATEGORY_SET.all, 1290),
  displayField("annualData[].analystRevisions.ebitFy3Last3m", "EBIT FY+3 revisions last 3M", "Analyst Revisions", "detail", CATEGORY_SET.all, 1300),
  displayField("annualData[].analystRevisions.epsFy1Last1m", "EPS FY+1 revisions last 1M", "Analyst Revisions", "detail", CATEGORY_SET.allButUnprofitable, 1310),
  displayField("annualData[].analystRevisions.epsFy1Last3m", "EPS FY+1 revisions last 3M", "Analyst Revisions", "detail", CATEGORY_SET.allButUnprofitable, 1320),
  displayField("annualData[].analystRevisions.epsFy2Last1m", "EPS FY+2 revisions last 1M", "Analyst Revisions", "detail", CATEGORY_SET.allButUnprofitable, 1330),
  displayField("annualData[].analystRevisions.epsFy2Last3m", "EPS FY+2 revisions last 3M", "Analyst Revisions", "detail", CATEGORY_SET.allButUnprofitable, 1340),
  displayField("annualData[].analystRevisions.epsFy3Last1m", "EPS FY+3 revisions last 1M", "Analyst Revisions", "detail", CATEGORY_SET.allButUnprofitable, 1350),
  displayField("annualData[].analystRevisions.epsFy3Last3m", "EPS FY+3 revisions last 3M", "Analyst Revisions", "detail", CATEGORY_SET.allButUnprofitable, 1360),
  ...
  displayField("annualData[].forecastData.fy1.eps", "EPS FY+1", "EPS & Dividends", "detail", CATEGORY_SET.allButUnprofitable, 1420),
  displayField("annualData[].forecastData.fy2.eps", "EPS FY+2", "EPS & Dividends", "detail", CATEGORY_SET.allButUnprofitable, 1430),
  displayField("annualData[].forecastData.fy3.eps", "EPS FY+3", "EPS & Dividends", "detail", CATEGORY_SET.allButUnprofitable, 1440),
  displayField("annualData[].epsAndDividends.dyTrailing", "DY trailing", "EPS & Dividends", "detail", CATEGORY_SET.allButUnprofitable, 1450),
  displayField("annualData[].forecastData.fy1.dy", "DY FY+1", "EPS & Dividends", "detail", CATEGORY_SET.allButUnprofitable, 1460),
  displayField("annualData[].forecastData.fy2.dy", "DY FY+2", "EPS & Dividends", "detail", CATEGORY_SET.allButUnprofitable, 1470),
  displayField("annualData[].forecastData.fy3.dy", "DY FY+3", "EPS & Dividends", "detail", CATEGORY_SET.allButUnprofitable, 1480),
  displayField("annualData[].epsAndDividends.dpsTrailing", "DPS (trailing)", "EPS & Dividends", "detail", ["Profitable Hi Growth", "Lender"], 1490),
  displayField("annualData[].forecastData.fy1.dps", "DPS FY+1", "EPS & Dividends", "detail", CATEGORY_SET.allButUnprofitable, 1500),
  displayField("annualData[].forecastData.fy2.dps", "DPS FY+2", "EPS & Dividends", "detail", CATEGORY_SET.allButUnprofitable, 1510),
  displayField("annualData[].forecastData.fy3.dps", "DPS FY+3", "EPS & Dividends", "detail", CATEGORY_SET.allButUnprofitable, 1520),
];
